...
const LoginSignup = () => {
  ...
  return (
    <motion.div 
      className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 overflow-hidden bg-gradient-to-br from-blue-400 via-blue-500 to-indigo-600 dark:bg-gradient-to-br dark:from-slate-800 dark:via-slate-900 dark:via-gray-900 dark:to-black transition-all duration-500"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
