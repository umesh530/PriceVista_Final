...
const ContactFeedback = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-400 to-blue-600 dark:from-gray-900 dark:to-gray-950 overflow-hidden">
